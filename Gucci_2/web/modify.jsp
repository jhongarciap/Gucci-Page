...
<html>
    <head>
        ...
        <title>Gucci - Añadir producto</title>
        <meta charset="utf-8">
                    ...
                    <div class="col-md-6 order-md-last d-flex">
                        <form class="bg-white p-5 contact-form" id="form" method="POST" action="ProductosController?action=insert" autocomplete="off">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Código" id="txtCode" required name="all_code" value="<c:out value="${product.code}"/>">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Nombre" id="txtName" required name="all_name" value="<c:out value="${product.name}"/>>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Cantidad" id="txtAmount" required name="all_amount" value="<c:out value="${product.amount}"/>>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Valor" id="txtPrice" required name="all_price" value="<c:out value="${product.price}"/>>
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" placeholder="Especificaciones" id="txtSpecification" required name="all_specifications" cols="30" rows="7" value="<c:out value="${product.specifications}"/>></textarea>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                        <div class="text">
                            <div class="horizontal">
                                ...
                                <h1 class="mb-4 mt-3 bg-grou bg-blanco">Editar Producto</h1>
                            </div>
                        </div>
                    </div>
                </div>
